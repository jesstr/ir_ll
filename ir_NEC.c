...
void sendNEC(uint32_t data, uint8_t nbits, bool repeat) {
    ...
    // Data
    sendPulseDistanceWidthData(NEC_BIT_MARK, NEC_ONE_SPACE,
        NEC_BIT_MARK, NEC_ZERO_SPACE, data, nbits, true);
